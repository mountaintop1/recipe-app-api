...
class PublicIngredientsApiTests(TestCase):
    """Test the publicly available ingredients API/unauthenticated."""
    def setUp(self):
...
class PrivateIngredientsApiTests(TestCase):
    """Test the private ingredients API/authenticated."""
    def setUp(self):
        self.client = APIClient()
    ...
    def test_ingredients_limited_to_user(self):
        ...
        user2 = create_user('user2@example.com', 'testpass')
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # Check only the ingredient for the authenticated user is returned.
    ...
    def test_filter_ingredients_by_recipe(self):
    ...
    def test_filter_ingredients_by_recipe_unique(self):
        """Test returning ingredients by those assigned to recipes."""
